...
public class Playermove : MonoBehaviour
{
    ...
    private GlobalCharacterInfo.CHAR_TYPE selectedCharacterType;
    ...
    private GlobalCharacterInfo.CHAR_STATUS nowStatus = GlobalCharacterInfo.CHAR_STATUS.NULL;
    ...
    public bool IsPossibleCharaterChange()
    {
        ...
        return IsStatus(GlobalCharacterInfo.CHAR_STATUS.GROUND) && weaponController.CanAttackMotion() && skillController.GetNoSkillAction();
    }
